...
jQuery(document).ready(function () {
	jQuery(".filled-stars").click(function() {
		var s_with = jQuery(this).attr( "style" ).split(":");
		var star_rating = s_with[1];
		var star_width = star_rating.replace(";", "");
		if(star_width == " 20%"){
			
			jQuery("#Rating_1").prop('checked', true);
		}else if(star_width == " 40%"){
			jQuery("#Rating_2").prop('checked', true);
		}else if(star_width == " 60%"){
			jQuery("#Rating_3").prop('checked', true);
		}else if(star_width == " 80%"){
			jQuery("#Rating_4").prop('checked', true);
		}else if(star_width == " 100%"){
			jQuery("#Rating_5").prop('checked', true);
		}
	});
});